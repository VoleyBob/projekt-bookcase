 ...
 */
final class Version20180603111731 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__book_entity AS SELECT id, bookcase_id, title, author_name, author_surname, isbn13, publisher, format FROM book_entity');
        $this->addSql('DROP TABLE book_entity');
        $this->addSql('CREATE TABLE book_entity (id INTEGER NOT NULL, bookcase_id INTEGER NOT NULL, owner_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, author_name VARCHAR(100) NOT NULL COLLATE BINARY, author_surname VARCHAR(100) NOT NULL COLLATE BINARY, isbn13 VARCHAR(13) NOT NULL COLLATE BINARY, publisher VARCHAR(255) DEFAULT NULL COLLATE BINARY, format VARCHAR(10) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_27FF4FE51FF438FB FOREIGN KEY (bookcase_id) REFERENCES bookcase_entity (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_27FF4FE57E3C61F9 FOREIGN KEY (owner_id) REFERENCES fos_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO book_entity (id, bookcase_id, title, author_name, author_surname, isbn13, publisher, format) SELECT id, bookcase_id, title, author_name, author_surname, isbn13, publisher, format FROM __temp__book_entity');
